...
<body>
	<div class="container">
		<div class="payment-box">
			...
			<form action="/thanhtoan/submit" method="post">
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select class="form-select" name="phuongthuc" required>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="tongtien" readonly
						value="${tongTien}">
				</div>

				<a href="<c:url value='/redirect/qr_scan' />" class="btn btn-danger">Xac nhan thanh toan</a>
